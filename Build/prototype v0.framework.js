...
var ASM_CONSTS = {
  4414324: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4414379: ($0) => { performance.now = function() { return $0; }; },  
 4414427: ($0) => { performance.now = function() { return $0; }; },  
 4414475: () => { performance.now = Module['emscripten_get_now_backup']; }
};
